# 🤖 Fit en 30s — Shorts automaticos y gratis

Genera y publica un Short de fitness y gimnasio al dia en YouTube, en automatico y sin pagar suscripciones.

- **Voz:** edge-tts (neuronal, gratis) en GitHub Actions · voz configurada: `es-MX-JorgeNeural`
...
3. El workflow `.github/workflows/daily.yml` hace las dos cosas cada dia (~08:27 Espana).
...
- `YT_CLIENT_SECRET`
- `YT_REFRESH_TOKEN`
- `CHANNEL_HANDLE` — tu @handle para la marca de agua (ej. `@FitEn30s`)
